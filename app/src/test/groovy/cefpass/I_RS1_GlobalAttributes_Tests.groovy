...
class I_RS1_GlobalAttributes_Tests extends Specification{
    ...
    def "R_1_00___FILENAME_MUST_EXIST"() 
    {
        ...
        then:
            ...
            ex.getError() == RS1_GlobalAttributesException.Error.R_1_00___FILENAME_MUST_EXIST
    ...
    def "R_1_01___FILENAME_MATCHES_ACTUAL"() 
    {
        ...
        then:
            RS1_GlobalAttributesException ex = thrown()
            ex.getError() == RS1_GlobalAttributesException.Error.R_1_01___FILENAME_MATCHES_ACTUAL
    }
    ...
    def "R_1_02___FILE_FORMAT_VERSION_MUST_EXIST"() 
    {
        ...
        then:
            RS1_GlobalAttributesException ex = thrown()
            ex.getError() == RS1_GlobalAttributesException.Error.R_1_02___FILE_FORMAT_VERSION_MUST_EXIST
    }
    ...
    def "R_1_03___END_OF_RECORD_MARKER_MUST_EXIST"() 
    {
        ...
        then:
            RS1_GlobalAttributesException ex = thrown()
            ex.getError() == RS1_GlobalAttributesException.Error.R_1_03___END_OF_RECORD_MARKER_MUST_EXIST 
    }
